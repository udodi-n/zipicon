...
<div className="flex flex-col gap-6 w-fit lg:pb-20">
    ...
    <div className=" font-light h-15 w-full flex gap-6 justify-center lg:justify-start items-center">
    ...
    <div className="h-full px-5 w-45 bg-black invert rounded-full  flex justify-center gap-6 items-center gap-3">
        {/* div wrapper */}
...
<div  style={{ boxShadow: "0px 3px 5px #0000001e" }} className= {`lg:aspect-7/4 aspect-6/4 bg-white border-1 border-[#cccccc] rounded-2xl h-60 lg:h-60 bottom-0 right-0 mr-5 mb-5 overflow-hidden fixed ${selectState? 'block' : 'hidden'}`}>
<div className="flex flex-col h-full w-full">
    <div id="header" className="h-10 bg-[#7E1DFB] w-full flex justify-end items-center gap-2 px-4">
        ...
        <div className="flex h-full w-full" id="top">
            ...
            <div className="right  flex flex-col justify-center h-full w-full">
                ...
                <div>
                    ...
                    <p className="font-light"><a href="#" className="underline">add to container</a> / <a href="#" className="hover:underline">download</a></p>
                </div>
            </div>
        </div>
    </div>
